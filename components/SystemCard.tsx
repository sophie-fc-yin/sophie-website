...
export default function SystemCard({ system }: SystemCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-[#e8e8e6] p-7 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.06),0_2px_4px_rgba(0,0,0,0.03)] hover:-translate-y-0.5 transition-all duration-300">
      <div>
      ...
      <p className="text-sm text-[#6b6b6b] mt-3 leading-relaxed">{system.oneLiner}</p>

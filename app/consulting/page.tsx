  ...
  return (
    <main>
      <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
        ...
        <FadeIn delay={300}>
          <div className="mt-20 md:mt-28">
            <h2 className="text-xl font-semibold text-[#1a1a1a]">What&apos;s Available</h2>
            <div className="mt-8 space-y-4">
              ...
              <div className="bg-white rounded-xl border border-[#e8e8e6] shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] p-7">
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-semibold text-[#1a1a1a] text-base">AI Systems Audit</p>
                </div>
              ...
              <div className="bg-white rounded-xl border border-[#e8e8e6] shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] p-7">
                <div className="flex items-center gap-2">
                  <span className="inline-block w-2 h-2 rounded-full bg-[#00d4aa]" />
                  <p className="font-semibold text-[#1a1a1a] text-base">AI Infrastructure Build</p>
                </div>
                <p className="text-sm text-[#6b6b6b] mt-3 leading-[1.75]">
              ...
              <div className="bg-white rounded-xl border border-[#e8e8e6] shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] p-7">
                <div className="flex items-center gap-2">
                  <span className="inline-block w-2 h-2 rounded-full bg-[#00d4aa]" />
                  <p className="font-semibold text-[#1a1a1a] text-base">Custom Agent Systems</p>
                </div>
                <p className="text-sm text-[#6b6b6b] mt-3 leading-[1.75]">
        ...
        <FadeIn delay={400}>
          <div id="contact" className="mt-20 md:mt-28">
            <p className="text-xl font-semibold text-[#1a1a1a]">If any of this sounds familiar, let&apos;s talk.</p>
            <div className="mt-6">
              <ContactForm />
            </div>
          </div>
